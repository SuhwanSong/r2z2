    ...
    def paint_test(self, html_file):
        ...
        for layer in layers:
            ...
            try:
                ...
                paint_log[snapId['snapshotId']] = ret
            except pychrome.exceptions.CallMethodException as e:
                pass

        compo_log = {}
        for layer in layers:
            compo_log[layer[lcfg.LID]] = tab.LayerTree.compositingReasons(layerId=layer[lcfg.LID])
#        print ('ids: ', ids)
#        print (paint_log)
#        for layer in layers:
...
#            layer.pop(lcfg.LPID, None)
        ...
        return {'layer': layers, 'paint': paint_log, 'composite': compo_log}
